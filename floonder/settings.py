"""
Django settings for floonder project.
...
SECRET_KEY = 'django-insecure-(3d)@uek1l*gc=vk7(h(!ar*!w7m0^oz*v3%-q8ld$)3xlclff'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://floonder.chevalierlabsas.org",
]
